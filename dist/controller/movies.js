...
var CtrlMovies = /** @class */ (function () {
     ...
     * @param body
     */
    CtrlMovies.create = function (body) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2 /*return*/, movies_1.default.create(body)];
            });
        });
    };
    /**
     ...
     *
     */
    CtrlMovies.findAll = function (page, limit, filterBy, order) {
        return __awaiter(this, void 0, void 0, function () {
            var ord;
            return __generator(this, function (_a) {
                ord = (order.toLowerCase() == "dsc") ? -1 : 1;
                if (filterBy.toLowerCase() == "showtime") {
                    return [2 /*return*/, movies_1.default
                            .aggregate([
                            {
                                $match: {
                                    $expr: { $gt: ["$showTime", Time_1.default.current()] }
                                }
                            },
                            {
                                $skip: page * limit,
